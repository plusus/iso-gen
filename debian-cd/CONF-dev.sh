...
export MIRROR=/home/prof/debianmirror

# Path of the temporary directory
export TDIR=$ABSOLUTEPREFIX/tmp/TDIR

# Path where the images will be written
export OUT=$ABSOLUTEPREFIX/output

# Where we keep the temporary apt stuff.
# This cannot reside on an NFS mount.
export APTTMP=$ABSOLUTEPREFIX/tmp/APTTMP
...
export LOCALDEBS=/home/prof/custommirror/apt/plus-us-dev
...
export BASE_INCLUDE=$ABSOLUTEPREFIX/hooks/base_include

# File with list of packages to exclude as above.
export BASE_EXCLUDE=$ABSOLUTEPREFIX/hooks/base_exclude
...
export KERNEL_PARAMS="preseed/file=/cdrom/preseed.cfg locale=fr_CA.UTF-8 keymap=ca language=fr country=CA timeout=1 acpi=off"
...
export DISC_START_HOOK=$ABSOLUTEPREFIX/hooks/preseedcp-dev.sh
...
#export DISC_FINISH_HOOK=$ABSOLUTEPREFIX/hooks/disc_finish_hook.sh
